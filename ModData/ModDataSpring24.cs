...
namespace CustomNPCFestivalAdditions.ModData
{
    ...
    */
    public class Spring24CharacterBlacklist
    {
        ...
        {
            this.ContentID = $"{charBlacklist.Source}_{DateTime.Now.ToString()}_Spring24CharacterBlacklist_{CharacterName}";
        ...
        public Spring24CharacterBlacklist(RawContent content)
        {
                ...
                && content.ContentFields.CharacterName != null)
            {
                ...
                this.ContentID = $"{content.ContentPack.Manifest.UniqueID}_{content.ContentPack.Manifest.Version.ToString()}_Spring24CharacterBlacklist_{content.ContentFields.CharacterName}";
    ...
    public class Spring24Sprite
    {
        ...
        public Spring24Sprite(RawContent content)
        {
            if (content.ContentType == "Spring24Sprite"
                && content.ContentFields.CharacterName != null
                && content.ContentFields.SpritesheetPath != null)
            {
                this.Source = "ContentPack";
